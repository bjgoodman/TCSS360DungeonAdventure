...
public class HeroAdventurer extends Hero {
    ...
    private static String MY_ABILITY = "Heroic Strike";
    ...
    public HeroAdventurer(String theName) {
        super(theName, MY_DESCRIPTION, MY_CHARACTER_TYPE, MY_DESCRIPTION, MY_REPRESENTING_CHARACTER, MY_ABILITY,
                MY_MAX_HP, MY_AD_MIN, MY_AD_MAX, MY_ACHANCE, MY_ABILITYCHANCE, MY_BLOCK_CHANCE);
    }
